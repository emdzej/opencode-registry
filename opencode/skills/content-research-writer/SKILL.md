...
> **Attribution:** This skill is based on the [content-research-writer](https://github.com/ComposioHQ/awesome-claude-skills/tree/master/content-research-writer) from ComposioHQ's Awesome Claude Skills repository, licensed under Apache-2.0.
